#ifndef __S_LANE_SAMPLING_H_INCLUDED__
#define __S_LANE_SAMPLING_H_INCLUDED__
...
struct S_lane_sampling
{
		// membres 
		vector <vector<C_SamplePoint> > traj_points; // matriu amb la discretitzacio espaial i la informacio de cadascun dels punts en que ha estat feta la discretització [station][offset]
		...
		float first_sampling_index; // index del vector 'traj_station' on acaba el priemer mostreig FI
};
#endif // !__S_LANE_SAMPLING_H_INCLUDED__
